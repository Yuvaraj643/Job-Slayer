              ...
              <section className="overflow-visible py-2 sm:w-100 mx-auto">
                <div className="w-full mx-auto p-10">
                  ...
                  <ul className="list-disc list-inside">
                    <li>
                      Prioritize your contact information, prominently
                      displaying your name, phone number, email address, and
                      LinkedIn profile (if applicable) at the top of your
                      resume.
                    </li>
                    <li>
                      Craft a succinct professional summary or objective
                      statement that articulately conveys your career goals and
                    ...
                    <li>
                      Highlight your technical proficiency, including
                      programming languages, tools, and software relevant to the
                    ...
                    <li>
                      Mention any certifications, training programs, or
                      workshops completed that are pertinent to the position.
                    </li>
                  </ul>
                  ...
                  <ul className="list-disc list-inside">
                    ...
                    <li>
                      Refrain from providing false information; honesty about
                      your skills is crucial as employers may verify during the
                      hiring process.
                    </li>
                    <li>
                    ...
                    <li>
                      Omit references directly from the resume; consider
                      providing a separate reference page if requested by the
                      employer.
                    </li>
                    <li>
                      Steer clear of lengthy paragraphs; opt for bullet points
                      and concise sentences to enhance readability.
                    </li>
                  </ul>
                </div>
